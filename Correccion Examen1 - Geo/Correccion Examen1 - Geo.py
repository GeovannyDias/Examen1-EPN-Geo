...
def opcion1():  # Figura Geometrica
    try:
        #root.withdraw()
        setup(640,480, 200,200)#Determina el tamaño de la ventana
        v = Screen()#Obtienen una referencia de la ventana
        v.clear()
        v.title("Figura Geometrica - Geo")
        v.bgcolor("gray")
        t = Pen()
        ...
        if n == 3:#TRIANGULO  ===========================================================
            ...
            hideturtle()
            goto(-160, -200)
            write("Perímetro = " + str(p),font=("arial", 15, "bold italic"))
            goto(-160, -230)
            write("Área = " + str(area),font=("arial", 15, "bold italic"))
...
root.geometry("640x480+200+200")  # Tamaño ventada + Coordenadas de posicion X,Y
root.resizable(0, 0)
